      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
              ...
              <div className="flex items-center gap-4">
                <div className="relative">
                  <img
                    src="/pic.jpg"
                    alt="Ayush Shah"
                    className="w-16 h-16 rounded-2xl object-cover border-2 border-purple-500/50 shadow-xl shadow-purple-500/20"
                  />
                ...
                <div>
                  ...
                  <p className="font-mono text-xs text-purple-400">Software Engineer @ Roboparadigm</p>
                </div>
              </div>

              <p className="text-neutral-300 text-base leading-relaxed">
                I am a passionate <strong className="text-white">Software Engineer</strong> based in Hyderabad, India. I specialize in building autonomous <strong className="text-purple-300">AI coding agents</strong>, low-latency backend architectures in <strong className="text-cyan-300">Rust & Go</strong>, and high-precision kinematics pipelines for <strong className="text-pink-300">ROS 2 robotic arms</strong>.
              </p>
            ...
            <div className="pt-6 mt-6 border-t border-white/10 flex flex-wrap gap-4 text-xs font-mono text-neutral-400">
          ...
          <motion.div
            ...
            className="md:col-span-5 rounded-3xl glass-panel glass-panel-hover p-8 relative overflow-hidden flex flex-col justify-between bg-gradient-to-b from-purple-950/20 via-transparent to-transparent"
          >
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs font-mono text-neutral-400 mt-1">17.3850° N, 78.4867° E</p>
              </div>

              {/* Dynamic Live Clock */}
              <div className="p-4 rounded-2xl bg-[#07080d] border border-white/10 font-mono text-center space-y-1">
                <div className="text-xs text-neutral-500 uppercase tracking-widest">LOCAL TIME</div>
            ...
            <div className="mt-6 pt-4 border-t border-white/10 text-xs font-mono text-neutral-400 flex items-center justify-between">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-2xl bg-[#08090e] border border-white/5">
                  ...
                  <div className="text-[11px] font-mono text-neutral-400 mt-1">Production Projects</div>
                </div>
                <div className="p-4 rounded-2xl bg-[#08090e] border border-white/5">
                  <div className="text-3xl font-black font-mono text-purple-400">23</div>
                  <div className="text-[11px] font-mono text-neutral-400 mt-1">Public GitHub Repos</div>
                </div>
                <div className="p-4 rounded-2xl bg-[#08090e] border border-white/5">
                  <div className="text-3xl font-black font-mono text-pink-400">7DOF</div>
                  <div className="text-[11px] font-mono text-neutral-400 mt-1">Robotic MTC Control</div>
                </div>
                <div className="p-4 rounded-2xl bg-[#08090e] border border-white/5">
                  <div className="text-3xl font-black font-mono text-cyan-400">sub-ms</div>
                  <div className="text-[11px] font-mono text-neutral-400 mt-1">Go Microservices</div>
                </div>
              </div>
            </div>
          </motion.div>
