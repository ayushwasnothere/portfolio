...
export const Hero: React.FC = () => {
  ...
  const techBadges = [
    { label: 'AI Agents', icon: Bot, color: 'from-indigo-500/20 to-indigo-500/5 text-indigo-300 border-indigo-500/30' },
    { label: 'ROS 2 & MoveIt', icon: Cpu, color: 'from-cyan-500/20 to-cyan-500/5 text-cyan-300 border-cyan-500/30' },
    { label: 'Rust & Tokio', icon: ShieldCheck, color: 'from-blue-500/20 to-blue-500/5 text-blue-300 border-blue-500/30' },
    { label: 'Go Systems', icon: Code2, color: 'from-emerald-500/20 to-emerald-500/5 text-emerald-300 border-emerald-500/30' },
  ];

  return (
    <section id="hero" className="relative min-h-screen pt-28 pb-16 flex flex-col justify-between overflow-hidden">
      {/* Refined Deep Ambient Orbs (Indigo & Cyan) */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-600/10 rounded-full blur-[140px] pointer-events-none animate-pulse-slow" />
      <div className="absolute top-1/3 right-[-10%] w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[140px] pointer-events-none animate-pulse-slow" />
      <div className="absolute bottom-10 left-[-5%] w-[450px] h-[450px] bg-cyan-600/10 rounded-full blur-[120px] pointer-events-none animate-pulse-slow" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full glass-panel border-indigo-500/30 text-xs font-mono text-indigo-300"
            >
            ...
            >
              <a
                ...
                data-cursor="EXPLORE"
                className="group relative inline-flex items-center gap-3 px-7 py-3.5 rounded-full bg-white text-slate-950 font-mono font-bold text-sm hover:bg-slate-200 hover:scale-105 transition-all duration-300 shadow-xl shadow-white/10"
              >
              ...
              <a
                ...
                data-cursor="ABOUT"
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full glass-panel glass-panel-hover font-mono text-sm text-slate-300 hover:text-white"
              >
                <span>ABOUT ME</span>
              </a>
            </motion.div>
          ...
          >
            <div className="rounded-2xl glass-panel border border-white/10 overflow-hidden shadow-2xl shadow-indigo-950/30">
              ...
              {/* Terminal Body */}
              <div className="p-5 font-mono text-xs space-y-3 bg-[#06070a]/90 text-slate-300 min-h-[320px] flex flex-col justify-between">
                <div className="space-y-2">
                  <div className="text-slate-500">// Initialize Forge Terminal AI Agent</div>
                  ...
                  {terminalText.length > 20 && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      className="pt-2 space-y-1.5 text-slate-400"
                    >
                      ...
                      <div className="text-indigo-400">✓ Tokio Async Mail Engine: READY</div>
                      <div className="text-blue-400">✓ WebSockets Realtime Engine: ONLINE</div>
                    </motion.div>
                  )}
                </div>
      ...
      <div className="mt-16 py-4 border-y border-white/5 bg-[#06070a]/60 backdrop-blur-md overflow-hidden">
        <div className="flex whitespace-nowrap animate-marquee-left font-mono text-xs font-semibold text-slate-400 tracking-wider">
